 ...
 */
+(void)displayYesNoAlertWithTitle:(NSString *)title
                          message:(NSString *)message
                        yesAction:(TriceAlertAction)yesAction
                         noAction:(TriceAlertAction)noAction;
 ...
 */
+(void)displayOkAlertWithTitle:(NSString *)title
                       message:(NSString *)message
                      okAction:(TriceAlertAction)okAction;
